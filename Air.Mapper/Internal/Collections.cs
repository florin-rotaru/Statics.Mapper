...
namespace Air.Mapper.Internal
{
    internal class Collections
    {
        ...
        public static Type GetGenericBaseType(Type type, Type baseTypeGenericTypeDefinition)
        {
            Type baseType = type.BaseType;
            if (baseType == null)
            {
                if (type.IsGenericType && type.GetGenericTypeDefinition() == baseTypeGenericTypeDefinition)
                    return type;
            }
            else
            {
                ...
                {
                    if (baseType.IsGenericType && type.GetGenericTypeDefinition() == baseTypeGenericTypeDefinition)
